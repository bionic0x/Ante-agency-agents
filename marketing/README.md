...
|---|---|---|
| [Marketing Strategy Orchestrator](marketing-strategy-orchestrator.md) | Coordinate the complete multi-agent marketing lifecycle | A request spans diagnosis, choice, execution, learning, and/or termination |
| [Marketing Strategy Director](marketing-strategy-director.md) | Own the marketing strategic thesis and decision package | The business needs to decide what to do, not merely how to execute a tactic |
...
| [Marketing Strategic Red Team](marketing-strategic-red-team.md) | Challenge the preferred route before commitment and scale | A marketing strategy is about to receive material or irreversible resources |

These roles do not replace the human decision owner or the repository-wide Strategic Assurance Lead.

## Intervention specialists

These remain deep specialists, but for material work they receive a strategic handoff rather than inventing the upstream strategy themselves.
...
If upstream information does not exist, expose the gap instead of fabricating strategy.

## Core principles

- End before medium: superior result before channel or metric.
- Diagnosis before tool: available capability does not define the problem.
...
- Authority before commitment: tool access is not permission.
